...
const expectedOperations = [
  ...
  ['POST', '/transactions/transfer/pair'],
  ['POST', '/transactions/transfer/unpair'],
  ['POST', '/transactions/{id}/pair'],
  ['POST', '/transactions/{id}/unpair'],
  ['POST', '/transactions/{id}/split'],
  ['POST', '/transactions/{id}/unsplit'],
  ['GET', '/transactions/rules'],
  ['GET', '/transactions/rules/all'],
  ['POST', '/transactions/rules'],
  ['POST', '/transactions/rules/advanced'],
  ['PATCH', '/transactions/rules/{id}'],
  ['PATCH', '/transactions/rules/advanced/{id}'],
  ['POST', '/transactions/rules/choice'],
  ['PATCH', '/transactions/rules/choice/{id}'],
  ['DELETE', '/transactions/rules/choice/{id}'],
  ...
  ['GET', '/settings'],
  ['GET', '/settings/ai-profiles'],
  ['POST', '/settings/ai-profiles'],
  ['PUT', '/settings/ai-profiles/active'],
  ['PUT', '/settings/ai-profiles/{id}'],
  ['DELETE', '/settings/ai-profiles/{id}'],
  ['GET', '/settings/ai-profiles/{id}/shares'],
  ['PUT', '/settings/ai-profiles/{id}/shares'],
